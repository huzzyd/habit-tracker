...
- Stack, accepted in `decisions/001-catch-entry-and-stack.md`: Expo with EAS, Swift and Kotlin targets for the entry surfaces. The data model in section 10 is logical only.
